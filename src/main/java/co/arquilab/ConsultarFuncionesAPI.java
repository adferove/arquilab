...
public class ConsultarFuncionesAPI implements Serializable{
	...
	public void mostrarMensajeGlobalParametros(String aIdProperties, String aTipo, String[] args) {
		...
		if (aTipo == null || (aTipo != null && aTipo.equals("exito"))) {
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "", this.getMensajeParametros(aIdProperties,args)));
		} else if (aTipo == null || (aTipo != null && aTipo.equals("advertencia"))) {
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "", this.getMensajeParametros(aIdProperties,args)));
		} else {
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "", this.getMensajeParametros(aIdProperties,args)));
		}
	}
	...
	public void mostrarMensajeGlobal(String aIdProperties, String aTipo) {
		...
		if (aTipo == null || (aTipo != null && aTipo.equals("exito"))) {
			...
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "", this.getMensaje(aIdProperties)));

		} else if (aTipo == null || (aTipo != null && aTipo.equals("advertencia"))) {

			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "", this.getMensaje(aIdProperties)));

		} else {

			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "", this.getMensaje(aIdProperties)));
		}
	}
